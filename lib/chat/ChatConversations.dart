import 'package:yourdailylight/utils/Alerts.dart';
  ...
  Widget build(BuildContext context) {
    if (widget.chatManager!.fetchingSelectedChatDetails) {
      ...
      return NoitemScreen(
        title: "",
        message:
            t.unabletofetchconversation + widget.selectedChat!.partner!.name!,
        onClick: () {
